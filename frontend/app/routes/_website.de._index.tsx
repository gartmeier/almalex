...
let content: LandingPageContent = {
  ...
  hero: {
    ...
    trustBadges: ["100% kostenlos", "KI aus der Schweiz", "Keine Anmeldung nötig"],
  },
  chatPreview: {
  ...
  howItWorks: {
    ...
    steps: [
      { title: "Frage stellen", desc: "Stell deine Rechtsfrage in normaler Sprache, egal ob zu OR, ZGB oder einem konkreten Fall." },
      { title: "Quellen durchsuchen", desc: "Die KI durchsucht Bundesrecht und tausende Bundesgerichtsentscheide in Sekunden." },
      { title: "Antwort erhalten", desc: "Du erhältst eine verständliche Antwort mit direkten Verweisen auf Gesetzesartikel und Urteile." },
    ],
  },
  dataSources: {
  ...
  privacy: {
    ...
    cards: [
      { title: "Keine Speicherung", desc: "Deine Chatverläufe bleiben lokal in deinem Browser. Nichts wird auf unseren Servern gespeichert." },
      { title: "KI aus Genf", desc: "Die KI-Modelle laufen bei Infomaniak, einem Schweizer Cloud-Anbieter mit Rechenzentrum in Genf." },
      { title: "Server in Europa", desc: "Die Anwendung läuft auf einem eigenen Server in Finnland. Keine US-Cloud, alle Daten bleiben in Europa." },
    ],
    cards2: [
      { title: "Kein KI-Training", desc: "Deine Eingaben werden nie zum Trainieren von KI-Modellen verwendet." },
      { title: "Kein Login nötig", desc: "Einfach loslegen. Kein Account, keine E-Mail, keine persönlichen Daten nötig." },
    ],
  },
  faq: {
  ...
  openSource: {
    ...
    cards: [
      { title: "Schweizer Rechtsdatenbank", desc: "Basierend auf Schweizer Bundesrecht und Bundesgerichtsentscheiden. Die KI durchsucht aktuelle Quellen vor jeder Antwort." },
      { title: "Open-Source KI-Modelle", desc: "Mehrere Modelle zur Auswahl: GPT-OSS 120B, Qwen3, Llama 3.3, Apertus 70B und Mistral Small 3.2." },
      { title: "Präzise juristische Suche", desc: "BGE-Multilingual-Gemma2 für semantische Suche. BGE-Reranker-v2-m3 für präzises Ranking der Suchergebnisse." },
      { title: "Quellcode auf GitHub", desc: "Vollständiger Quellcode öffentlich verfügbar. Beiträge, Issues und Feedback willkommen." },
      { title: "KI-Hosting in der Schweiz", desc: "Alle KI-Modelle laufen bei Infomaniak in Genf. Keine Daten verlassen die Schweiz für die Verarbeitung." },
      { title: "Unabhängig von Big Tech", desc: "Kein OpenAI, kein Google, kein Microsoft. Ausschliesslich offene Modelle und eigene Infrastruktur." },
    ],
