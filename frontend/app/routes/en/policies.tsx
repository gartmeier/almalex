      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p className="mb-4">
              Alma Lex is a demo project by Joshua Gartmeier. This privacy
              policy informs you about data handling in this technical demo.
              Please note that all chats are publicly accessible.
            </p>
            ...
            <p className="mb-4">
              Chats are publicly accessible via their URL and can be viewed by
              anyone who knows the link. Chats are automatically deleted 30 days
              after the last activity. No personal data is collected or stored.
            </p>

            <h3 className="mt-6 mb-3 text-lg font-semibold">
              5. Public Nature of Chats
            </h3>
            <p className="mb-4">
              Please note that all chats are public. Anyone who knows the URL of
              a chat can view it. Therefore, do not share sensitive or personal
              information in the chats.
            </p>

            <h3 className="mt-6 mb-3 text-lg font-semibold">6. Your Control</h3>
            <p className="mb-4">
              Since no personal data is collected and chats are public, you have
              full control:
            </p>
            <ul className="mb-4 list-disc pl-6">
            ...
            <h3 className="mt-6 mb-3 text-lg font-semibold">7. Security</h3>
            <p className="mb-4">
              Data transmissions occur via SSL/TLS encrypted connections.
              However, keep in mind that all chats are publicly accessible via
              their URL. Therefore, do not share confidential information.
            </p>
        ...
        <section>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p className="mb-4">
              Alma Lex is a demo project by Joshua Gartmeier - an AI-powered
              platform that provides legal information based on Swiss law. This
              service is a demo, does not replace professional legal advice, and
            ...
            <ul className="mb-4 list-disc pl-6">
              ...
              <li>
                Not share sensitive or personal information (chats are public)
              </li>
              <li>
            ...
            <p className="mb-4">
              As this is a demo project, Joshua Gartmeier assumes no liability
              for direct, indirect, incidental, or consequential damages. Use is
              at your own risk.
            </p>

            <h3 className="mt-6 mb-3 text-lg font-semibold">7. Demo Usage</h3>
            <p className="mb-4">
              This demo may be modified or discontinued at any time without
              notice. There is no guarantee of permanent availability.
            </p>

            <h3 className="mt-6 mb-3 text-lg font-semibold">8. Changes</h3>
            <p className="mb-4">
              As this is a demo project, features and terms may be changed at
