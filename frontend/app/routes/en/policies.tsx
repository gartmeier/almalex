  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="mb-4 text-2xl font-semibold">{t("pages.policies.privacy.heading")}</h2>
        ...
        <section>
          <h2 className="mb-4 text-2xl font-semibold">{t("pages.policies.terms.heading")}</h2>
          <div className="prose max-w-none">
