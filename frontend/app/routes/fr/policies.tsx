      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p className="mb-4">
              En utilisant Alma Lex, vous acceptez ces conditions d'utilisation.
              Si vous n'êtes pas d'accord, veuillez ne pas utiliser notre
              service.
            </p>
            ...
            <p className="mb-4">
              Tout le contenu, les marques et les technologies d'Alma Lex sont
              protégés par le droit d'auteur. Vous recevez une licence limitée
              et non transférable pour un usage personnel du service.
            </p>
            ...
            <p className="mb-4">
              Ces conditions sont régies par le droit suisse. Le tribunal
              compétent est celui de Zurich, Suisse.
            </p>
